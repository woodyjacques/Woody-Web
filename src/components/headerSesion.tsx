...
function HeaderSesion() {
    ...
    return (
        <div>
            <nav className="fixed w-full z-20 top-0 left-0 border-b  border-gray-600 bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="https://res.cloudinary.com/dol6yfeoi/image/upload/v1711906350/unnamed_ulj6qg.jpg" className="h-8" />
                    ...
                    >
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-gray-800 md:bg-gray-900 border-gray-700">
                            ...
                            <li>
                                <NavLink
                                    to="#" onClick={showModal}
                                    className={`block py-1 pl-2 pr-2 rounded ${location.pathname === "#"
                                        ? "text-white"
                                        : "md:hover:text-white"
