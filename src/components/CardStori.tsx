...
import { obtenerRelatos } from "../validation/Stori";
                    ...
                    stori.map((sto, index) => (
                        ...
                        >
                            ...
                            <div className="px-5 pb-5">
                                ...
                                <p className="text-white"> {sto.description}</p>
                                <div className="flex items-center justify-between">
                                    {tokens ? (
                                        <a href={`/woody-donacion?link=${encodeURIComponent(sto.linkVer)}`}>
                                            <div
